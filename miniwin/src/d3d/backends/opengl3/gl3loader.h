...
// Minimal OpenGL 3.3 core loader via SDL_GL_GetProcAddress — no external dependency.
...
#define GL3_FUNCTION_LIST                                                                                              \
	...
	GL3_FUNC(void, glClearColor, (GLclampf r, GLclampf g, GLclampf b, GLclampf a))                                     \
	GL3_FUNC(void, glClearDepth, (GLclampd depth))                                                                     \
	GL3_FUNC(void, glViewport, (GLint x, GLint y, GLsizei width, GLsizei height))                                      \
	GL3_FUNC(void, glScissor, (GLint x, GLint y, GLsizei width, GLsizei height))                                       \
	GL3_FUNC(void, glDepthFunc, (GLenum func))                                                                         \
	GL3_FUNC(void, glDepthMask, (GLboolean flag))                                                                      \
	GL3_FUNC(void, glBlendFunc, (GLenum sfactor, GLenum dfactor))                                                      \
	GL3_FUNC(void, glCullFace, (GLenum mode))                                                                          \
...
struct Gl3Functions {
#define GL3_FUNC(ret, name, args) name##_t name = nullptr;
	GL3_FUNCTION_LIST
#undef GL3_FUNC
